    ...
    methods: {
        check_username: function () {
            ...
            if (this.error_name == false) {
                axios.get(this.host + '/userNameCount/' + this.username, {
                    responseType: 'json'
                })
                    .then(response => {
        ...
        check_phone: function () {
            ...
            if (re.test(this.mobile)) {
                ...
                this.error_phone_message = '您输入的⼿手机号格式不不正确';
                this.error_phone = true;
            }
            if (this.error_phone == false) {
                axios.get(this.host + '/userMobileCount/' + this.mobile, {
                    responseType: 'json'
                })
                    .then(response => {
                        if (response.data.count > 0) {
        ...
        on_submit: function () {
            ...
            if (this.error_name == false && this.error_password == false && this.error_check_password == false
                ...
                axios.post(this.host + '/userRegister/', {
